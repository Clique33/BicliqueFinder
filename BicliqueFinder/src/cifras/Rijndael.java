 ...
 * @author ´Gabriel
 */
public class Rijndael extends Cipher{    	
    ...
    // Xtime3[x] = x^Xtime2[x];
    private static final int[] X_TIMES_2 = {
...
//        ArrayList<ByteArray> block3 = ByteArray.concatenateAll(new Rijndael().expandKey(block,2)).split(16);
//        ArrayList<ByteArray> block4 = ByteArray.concatenateAll(new Rijndael().expandKey(block2,2)).split(16);
//        System.out.println(block);
//        System.out.println(block2);
//        System.out.println("keyDiff : "+block.clone().autoXor(block2));
...
//            aux = block3.get(i).clone().autoXor(block4.get(i));
////            aux.setShape("4x4");
...
//        block.randomize();
//        ByteArray block2 = block.clone();
//        Rijndael aes1 = new Rijndael(key1,10);
//        Rijndael aes2 = new Rijndael(key2,10);
...
//        
//        ArrayList<ByteArray> block3 = aes1.encryptFull(block, 10);
//        ArrayList<ByteArray> block4 = aes2.encryptFull(block2, 10);
//        
//        System.out.println(block);
//        System.out.println(block2);
//        System.out.println("stateDiff :\n"+block.clone().autoXor(block2));
//        
//        System.out.println("keyDiff : ");
//        
//        for (int i = 0; i < expandedKey1.size(); i++) {
//            System.out.println(expandedKey1.get(i).clone().autoXor(expandedKey2.get(i)));
//        }
//        System.out.println("");
//        
//        for (ByteArray b : block3) {
...
//        for (int i = 0; i < block3.size(); i++) {
//            System.out.println(block3.get(i).clone().autoXor(block4.get(i)));
//        }
...
//        System.out.println("key1^key2 : "+key1.clone().autoXor(key2));
        System.out.println("key1^key2 : "+ByteArray.xor(key1,key2));
...
//        System.out.println("expandedKey1^expandedKey2 : "+expandedKey1.clone().autoXor(expandedKey2));
        System.out.println("expandedKey1^expandedKey2 : "+ByteArray.xor(expandedKey1,expandedKey2));
        ...
        aes1 = new Rijndael(key1, 10);
        aes2 = new Rijndael(key2, 8);
...
//        System.out.println("expandedKey1^expandedKey2 : "+expandedKey1.clone().autoXor(expandedKey2));
    ...
    public Rijndael(ByteArray key){
        setWordSize(8);
        setKey(key, 0);
    }

    public Rijndael(ByteArray key,int round){
        setWordSize(8);
        setKey(key, round);
    }
    
    private ArrayList<ByteArray> expandKey(ByteArray key)  {
            return expandKey(key, 0);
    }
    
    public ArrayList<ByteArray> decryptFull(ByteArray block){
        return decryptRounds(block, 0, getNUM_ROUNDS());
    }
...
//            else currBlock = currBlock.autoXor(internalExpandedKey.get(i+1));
            else currBlock = currBlock.autoXor(internalExpandedKey.get(i+1));
            ...
            currBlock = currBlock.autoXor(internalExpandedKey.get(i));
            internalStates.add(currBlock);
        }
        return internalStates;
    }
        
    public ByteArray rcon(ByteArray col, int round)  {
    ...
    public ByteArray rotWord(ByteArray col) {
...
//        System.out.println("col:"+col);
    ...
    public ByteArray subWord(ByteArray col)  {
        //ByteArray col = key.getColumn(column);
    ...
    public ByteArray inverseRotWord(ByteArray col) {
        //ByteArray col = key.getColumn(column);
    ...
    public ByteArray inverseSubWord(ByteArray col)  {
        for (int i = 0; i < col.length(); i++) 
    ...
    public ArrayList<ByteArray> expandKey(ByteArray key, int round) {
        ...
        key.setShape("4x4", WordSize.BYTE);
        ...
        for (int i = round-1; i >=0; i--) {
            ...
            aux = new ByteArray(getROUND_KEY_SIZE_IN_BYTES());
            aux.setShape("4x4", WordSize.BYTE);
            aux.setColumn(3, keys.get(0).getColumn(3).autoXor(keys.get(0).getColumn(2)));
            aux.setColumn(2, keys.get(0).getColumn(2).autoXor(keys.get(0).getColumn(1)));
            aux.setColumn(1, keys.get(0).getColumn(1).autoXor(keys.get(0).getColumn(0)));
            ...
            aux.setColumn(0, keys.get(0).getColumn(0).autoXor(col));
            keys.add(0, aux);
            //System.out.println(keys);
        }
        int pos = keys.size()-1;
        for (int i = round; i < getNUM_ROUNDS(); i++) {
...
//            System.out.println("col(after rcon) : "+col);
            aux = new ByteArray(getROUND_KEY_SIZE_IN_BYTES());
            aux.setShape("4x4", WordSize.BYTE);
            aux.setColumn(0, col.autoXor(keys.get(i-round+pos).getColumn(0)));
            aux.setColumn(1, aux.getColumn(0).autoXor(keys.get(i-round+pos).getColumn(1)));
            aux.setColumn(2, aux.getColumn(1).autoXor(keys.get(i-round+pos).getColumn(2)));
            aux.setColumn(3, aux.getColumn(2).autoXor(keys.get(i-round+pos).getColumn(3)));
//            System.out.println("key : "+aux);
            keys.add(aux);
        }
        key.setShape(originalShape, WordSize.BYTE);
        return keys;
    }
    ...
    public ByteArray shiftRows(ByteArray block) {
        ...
        try {
            if(!originalShape.equals("4x4")) result.setShape("4x4", WordSize.BYTE);
            for (int i = 0; i < result.getNumRows(); i++) 
                for (int j = 0; j < i; j++) result.rotateRow(i, WordSize.BYTE);
            if(!originalShape.equals("4x4")) result.setShape(originalShape, WordSize.BYTE);
            
        } catch (Exception ex) {
            if(block.length()!= getBLOCK_SIZE_IN_BYTES()) System.out.println("shiftRows Exception : block has length "+block.length()+". (must be "+getBLOCK_SIZE_IN_BYTES()+")");
            //Never happens
            ex.printStackTrace();
        }
        return result;
    ...
    public ByteArray invertedShiftRows(ByteArray block) {
        ...
        try {
            if(!originalShape.equals("4x4")) result.setShape("4x4", WordSize.BYTE);
            for (int i = 0; i < result.getNumRows(); i++) 
                for (int j = 0; j < result.getNumRows()-i; j++) result.rotateRow(i, WordSize.BYTE);
            if(!originalShape.equals("4x4")) result.setShape(originalShape, WordSize.BYTE);
    ...
    public ByteArray getExpandedKey() {
        if(secretKey == null) throw new RuntimeException("secretKey é null por"
                                                             + " algum motivo");     
